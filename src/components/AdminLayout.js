        ...
        <aside className={`sidebar ${openMenu ? "show" : ""}`}>
          ...
          <nav className="sidebar-nav">
            ...
            <div className={`submenu ${openLaporan || isLaporanActive ? "open" : ""}`}>
              <a
                href="/admin/reports"
                className={`submenu-item ${currentPath === "/admin/reports" ? "active" : ""}`}
                onClick={() => setOpenMenu(false)}
              >
              ...
              <a
                href="/admin/reports/rekap-pembayaran"
                className={`submenu-item ${currentPath === "/admin/reports/rekap-pembayaran" ? "active" : ""}`}
                onClick={() => setOpenMenu(false)}
              >
                <span className="submenu-icon">✅</span>
                Rekap Pembayaran
              ...
              <a
                href="/admin/reports/rekap-santri"
                className={`submenu-item ${currentPath === "/admin/reports/rekap-santri" ? "active" : ""}`}
                onClick={() => setOpenMenu(false)}
              >
                <span className="submenu-icon">🎓</span>
                Rekap Santri
              ...
              <a
                href="/admin/reports/absensi"
                className={`submenu-item ${currentPath === "/admin/reports/absensi" ? "active" : ""}`}
                onClick={() => setOpenMenu(false)}
              >
                <span className="submenu-icon">📋</span>
                Absensi Santri
          ...
          <div className="topbar">
            <div className="topbar-left">
              ...
              <span className="topbar-title">
                {currentPath === "/admin/reports/rekap-santri"
                  ? "Rekap Santri"
                  : currentPath === "/admin/reports/rekap-pembayaran"
                  ? "Rekap Pembayaran"
                  : currentPath === "/admin/reports/absensi"
                  ? "Absensi Santri"
                  : menuItems.find(m => currentPath === m.href || currentPath.startsWith(m.href + "/"))?.label || "Admin Panel"}
              </span>
            </div>
